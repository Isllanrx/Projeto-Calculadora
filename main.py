#=============================================== CRIADOR ISLLAN TOSO PEREIRA ================|
#=============================================== CALCULADORA BÁSICA =========================|
#=============================================== PRIMEIRO PROJETO COM PYTHON ================|
#============================================================================================|

# importando Tkinter // BIBLIOTECA 

from tkinter import *    # O "*" SIGNIFICA PARA IMPORTAR TUDO DESSA BIBLIOTECA
from tkinter import ttk  # O "TTK" SIGNIFICA PARA IMPORTAR TODAS FUNCIONALIDADES AVANÇADAS DESSA BIBLIOTECA

# Cores utilizadas:

cor1 = "#1b1c1b" # Preto Claro
cor2 = "#2a5985" # Azul Escuro
cor3 = "#db7b2c" # Laranja"
cor4 = "#f04a29" # Vermelho alaranjado
cor5 = "#ffffff" # Branco

# Criando a moldura da janela da calculadora:
...
app_Label = Label(frame_tela, textvariable=valor_texto, width=16, height=2, padx=7, relief=FLAT, anchor="e", justify=RIGHT, font=('Ivy 18'), bg=cor2, fg=cor5)
app_Label.place(x=0,y=0)

# Criando botôes da calculadora:
